...
const EXERCISES = [
  ...
  {
    id: 'L01', label: 'careers-workshop', voice: 'en-US-JennyNeural',
    exerciseIds: ['dr_L01'],
  ...
  {
    id: 'L05', label: 'academic-advisor', voice: 'en-US-JennyNeural',
  ...
  {
    id: 'L07', label: 'apartment-roommates', voice: 'en-US-JennyNeural',
  ...
  {
    id: 'L08', label: 'museum-volunteer', voice: 'en-US-AriaNeural',
  ...
  {
    id: 'L09', label: 'water-service', voice: 'en-US-JennyNeural',
  ...
  {
    id: 'L10', label: 'walking-podcast', voice: 'en-US-JennyNeural',
