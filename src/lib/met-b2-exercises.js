...
const SPEAKING = [
  {
    ...
    imageUrl: '/images/met/speaking/s03-coffee-shop.png',
  ...
  },
  {
    ...
    prompt: 'Look at the picture. Describe what you see.\n\n(Picture description: a group of people waiting for a bus in heavy rain; one person shares an umbrella with another; cars in the background)',
    targetSeconds: 60,
  ...
  },
  {
    ...
    imageUrl: '/images/met/speaking/s02-airport.png',
    imageAlt: 'People at an airport check-in counter with luggage, airline staff helping passengers, signs above',
    prompt: 'Look at the picture. Describe what you see.',
    targetSeconds: 60,
    scaffolding: { vocabulary: ['airport', 'check-in', 'luggage', 'passengers', 'counter', 'queue'], structure: ['Describe the setting and people', 'Describe what they are doing', 'Add inference about the situation', 'Give overall impression'] },
    note: 'Sample response (45-60s): This picture shows a busy airport check-in area with several passengers waiting in line with their luggage. An airline staff member is behind the counter, helping a customer. The environment looks organized but busy, suggesting it may be a popular travel time. I can see signs and screens above the counters, which probably show flight information. The overall impression is that of a modern, efficient airport where people are preparing for their journeys.',
  },
  {
