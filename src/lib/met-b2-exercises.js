...
const LISTENING = [
  {
    id: drId('dr_L12a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L12-urban-planning.mp3',
    audioText: 'Although many urban planners argue that high-density housing is essential for growth, some residents believe it may alleviate the housing shortage while simultaneously diminishing community green spaces. The challenge lies in balancing modern infrastructure needs with the preservation of local parks, which are vital for the well-being of citizens. Ultimately, town councils must prioritize sustainable designs that integrate nature into the urban landscape rather than sacrificing it for concrete expansion.',
    question: 'What is the main conflict mentioned regarding urban growth?', options: ['The high cost of building new homes', 'Balancing housing needs with the preservation of green spaces', 'A lack of qualified urban planners', 'The difficulty of accessing city centers'], correct: 1,
  },
  {
    id: drId('dr_L12b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L12-urban-planning.mp3',
    audioText: 'Although many urban planners argue that high-density housing is essential for growth, some residents believe it may alleviate the housing shortage while simultaneously diminishing community green spaces. The challenge lies in balancing modern infrastructure needs with the preservation of local parks, which are vital for the well-being of citizens. Ultimately, town councils must prioritize sustainable designs that integrate nature into the urban landscape rather than sacrificing it for concrete expansion.',
    question: 'What is a potential downside of high-density housing according to some residents?', options: ['It increases the cost of living', 'It may lead to a decrease in community green spaces', 'It makes the city too noisy', 'It prevents the growth of local businesses'], correct: 1,
  },
  {
    id: drId('dr_L12c'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L12-urban-planning.mp3',
    audioText: 'Although many urban planners argue that high-density housing is essential for growth, some residents believe it may alleviate the housing shortage while simultaneously diminishing community green spaces. The challenge lies in balancing modern infrastructure needs with the preservation of local parks, which are vital for the well-being of citizens. Ultimately, town councils must prioritize sustainable designs that integrate nature into the urban landscape rather than sacrificing it for concrete expansion.',
    question: 'What does the author suggest town councils should prioritize?', options: ['Rapid concrete expansion', 'Reducing the amount of social housing', 'Sustainable designs that integrate nature', 'Removing all local parks to make room for homes'], correct: 2,
  },
  {
    id: drId('dr_L01'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L01-careers-workshop.mp3',
    audioText: 'W: Are you going to the careers workshop this afternoon?\nM: Not today. They moved it to next Thursday because the guest speaker missed her flight.\nW: I\'m glad you told me. I was about to leave for the hall.\nN: What does the man say about the workshop?',
    question: 'What does the man say about the workshop?', options: ['It has started late.', 'It will happen on another day.', 'It is only for new students.', 'It has changed rooms.'], correct: 1,
  },
  {
    id: drId('dr_L02'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L02-printer-handouts.mp3',
    audioText: 'W: Did you print the handouts for the meeting?\nM: I tried, but the printer is out of paper, so I emailed everyone a copy instead.\nW: Fine. That should work for today.\nN: What problem did the man have?',
    question: 'What problem did the man have?', options: ['He forgot the handouts at home.', 'The printer had no paper.', 'He sent the wrong file.', 'The meeting started early.'], correct: 1,
  },
  {
    id: drId('dr_L03'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L03-old-phone.mp3',
    audioText: 'M: I can\'t believe your phone still works after all these years.\nW: Barely. I\'m keeping it until next month, when the newer model goes on sale.\nN: What will the woman probably do next month?',
    question: 'What will the woman probably do next month?', options: ['Repair her old phone.', 'Borrow a phone from a friend.', 'Change her phone plan.', 'Buy a new phone.'], correct: 3,
  },
  {
    id: drId('dr_L04'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L04-noisy-window.mp3',
    audioText: 'W: Could you close the window? The traffic is really loud today.\nM: I\'d rather leave it open because it\'s warm in here, but if the noise is bothering you, I can shut it.\nN: What does the man mean?',
    question: 'What does the man mean?', options: ['He thinks the room is already too cold.', 'He wants the woman to move seats.', 'He prefers the window open but is willing to close it.', 'He cannot hear the traffic at all.'], correct: 2,
  },
  {
    id: drId('dr_L05a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L05-academic-advisor.mp3',
    audioText: 'N: Listen to a conversation between a student and an academic advisor.\nAdvisor: So, you\'re thinking about taking Introduction to Marketing next term?\nStudent: Yes, but the only section I can see is on Tuesday evenings, and that\'s when I usually work.\nAdvisor: There is an online section, but it fills up quickly. If you want that one, you should register today.\nStudent: I was hoping to take the in-person class because I learn better when I can ask questions right away.\nAdvisor: That makes sense. Still, the online section might be the better choice if your work schedule can\'t change.\nStudent: True. I\'ll call my manager this afternoon and see whether I can switch shifts. If not, I\'ll take the online class.\nN: Now answer the questions.',
    question: 'Why is the student worried about the course?', options: ['He has already failed it once.', 'He may not be free at the class time.', 'He cannot find the classroom.', 'He thinks the teacher is too strict.'], correct: 1,
  },
  {
    id: drId('dr_L05b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L05-academic-advisor.mp3',
    audioText: 'N: Listen to a conversation between a student and an academic advisor.\nAdvisor: So, you\'re thinking about taking Introduction to Marketing next term?\nStudent: Yes, but the only section I can see is on Tuesday evenings, and that\'s when I usually work.\nAdvisor: There is an online section, but it fills up quickly. If you want that one, you should register today.\nStudent: I was hoping to take the in-person class because I learn better when I can ask questions right away.\nAdvisor: That makes sense. Still, the online section might be the better choice if your work schedule can\'t change.\nStudent: True. I\'ll call my manager this afternoon and see whether I can switch shifts. If not, I\'ll take the online class.\nN: Now answer the questions.',
    question: 'What will the student probably do first?', options: ['Drop the course completely.', 'Register for a different subject.', 'Ask his manager about his work hours.', 'Join the online class immediately.'], correct: 2,
  },
  {
    id: drId('dr_L06a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L06-bike-rental.mp3',
    audioText: 'N: Listen to a conversation in a bike rental shop.\nAssistant: Are you renting for the city or for the trails?\nCustomer: For the trails. My brother is visiting, and we planned a ride for Saturday.\nAssistant: In that case, I should tell you that the hill trail is partly closed after last week\'s heavy rain.\nCustomer: Oh. Is there another route you\'d recommend?\nAssistant: Yes. The river route is open, and it\'s easier too. I\'d also suggest helmets and a repair kit.\nCustomer: We definitely need helmets. Do they come with the bikes?\nAssistant: They do, but the repair kit costs extra.\nCustomer: That\'s fine. Let\'s do two bikes, two helmets, and one repair kit.\nN: Now answer the questions.',
    question: 'Why does the assistant mention the hill trail?', options: ['To explain why the shop is busy', 'To warn the customer about a route problem', 'To suggest a more expensive bike', 'To ask whether the customer is experienced'], correct: 1,
  },
  {
    id: drId('dr_L06b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L06-bike-rental.mp3',
    audioText: 'N: Listen to a conversation in a bike rental shop.\nAssistant: Are you renting for the city or for the trails?\nCustomer: For the trails. My brother is visiting, and we planned a ride for Saturday.\nAssistant: In that case, I should tell you that the hill trail is partly closed after last week\'s heavy rain.\nCustomer: Oh. Is there another route you\'d recommend?\nAssistant: Yes. The river route is open, and it\'s easier too. I\'d also suggest helmets and a repair kit.\nCustomer: We definitely need helmets. Do they come with the bikes?\nAssistant: They do, but the repair kit costs extra.\nCustomer: That\'s fine. Let\'s do two bikes, two helmets, and one repair kit.\nN: Now answer the questions.',
    question: 'What will the customer probably rent?', options: ['Two bikes and one helmet', 'One bike and one repair kit', 'Two bikes, helmets, and a repair kit', 'Two bikes only'], correct: 2,
  },
  {
    id: drId('dr_L07a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L07-apartment-roommates.mp3',
    audioText: 'N: Listen to two roommates talking about an apartment.\nW: I like the apartment on Green Street. It\'s cheaper than the others, and the kitchen is much nicer.\nM: I liked that one too, but it\'s pretty far from the train station.\nW: That\'s true, although the bus stop is right outside.\nM: Did you notice how small the bedrooms were? I\'m not sure my desk would fit.\nW: Mine probably would, but just barely. On the other hand, internet is included in the rent, which would save us money every month.\nM: Good point. Why don\'t we visit it again on Friday and measure the rooms?\nW: That sounds like the best plan.\nN: Now answer the questions.',
    question: 'What does the woman see as an advantage of the apartment?', options: ['It is close to the train station.', 'It has larger bedrooms.', 'It costs less and has a better kitchen.', 'It has new furniture included.'], correct: 2,
  },
  {
    id: drId('dr_L07b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L07-apartment-roommates.mp3',
    audioText: 'N: Listen to two roommates talking about an apartment.\nW: I like the apartment on Green Street. It\'s cheaper than the others, and the kitchen is much nicer.\nM: I liked that one too, but it\'s pretty far from the train station.\nW: That\'s true, although the bus stop is right outside.\nM: Did you notice how small the bedrooms were? I\'m not sure my desk would fit.\nW: Mine probably would, but just barely. On the other hand, internet is included in the rent, which would save us money every month.\nM: Good point. Why don\'t we visit it again on Friday and measure the rooms?\nW: That sounds like the best plan.\nN: Now answer the questions.',
    question: 'What do the speakers decide to do?', options: ['Sign the contract that day', 'Visit the apartment again', 'Look for a third roommate', 'Cancel all future viewings'], correct: 1,
  },
  {
    id: drId('dr_L08a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L08-museum-volunteer.mp3',
    audioText: 'N: Listen to a volunteer coordinator speaking at a museum.\nCoordinator: Welcome, everyone, and thank you for volunteering at the City Museum this weekend. Please arrive fifteen minutes before your shift starts so you have time to collect your name badge and leave your bags in the staff room. During the event, most of you will be helping visitors find the correct galleries. If a visitor asks you a question you cannot answer, do not guess. Instead, send the visitor to the information desk near the main entrance. Finally, remember that food and drinks are not allowed in the exhibition rooms, so please finish them before you begin your shift.\nN: Now answer the questions.',
    question: 'What is the main purpose of the talk?', options: ['To invite people to a new museum exhibition', 'To explain weekend procedures to volunteers', 'To describe the history of the museum', 'To advertise paid positions'], correct: 1,
  },
  {
    id: drId('dr_L08b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L08-museum-volunteer.mp3',
    audioText: 'N: Listen to a volunteer coordinator speaking at a museum.\nCoordinator: Welcome, everyone, and thank you for volunteering at the City Museum this weekend. Please arrive fifteen minutes before your shift starts so you have time to collect your name badge and leave your bags in the staff room. During the event, most of you will be helping visitors find the correct galleries. If a visitor asks you a question you cannot answer, do not guess. Instead, send the visitor to the information desk near the main entrance. Finally, remember that food and drinks are not allowed in the exhibition rooms, so please finish them before you begin your shift.\nN: Now answer the questions.',
    question: 'What should volunteers do if they do not know an answer?', options: ['Ask another visitor', 'Look it up on their phones', 'Send the visitor to the information desk', 'Write the question down for later'], correct: 2,
  },
  {
    id: drId('dr_L09a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L09-water-service.mp3',
    audioText: 'N: Listen to a public service announcement.\nAnnouncer: This is a reminder for residents of North Park. Water service will be temporarily interrupted tonight from ten p.m. until approximately six a.m. while the city replaces an old underground pipe. Residents are advised to store enough water for drinking and basic cleaning before ten p.m. If possible, avoid using washing machines or dishwashers until service is fully restored in the morning. A supply tank with bottled water will be available at the North Park Community Center for elderly residents and others with urgent needs.\nN: Now answer the questions.',
    question: 'Why will the water service be interrupted?', options: ['Because of unusually hot weather', 'Because the city is replacing a pipe', 'Because the community center is being repaired', 'Because residents used too much water'], correct: 1,
  },
  {
    id: drId('dr_L09b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L09-water-service.mp3',
    audioText: 'N: Listen to a public service announcement.\nAnnouncer: This is a reminder for residents of North Park. Water service will be temporarily interrupted tonight from ten p.m. until approximately six a.m. while the city replaces an old underground pipe. Residents are advised to store enough water for drinking and basic cleaning before ten p.m. If possible, avoid using washing machines or dishwashers until service is fully restored in the morning. A supply tank with bottled water will be available at the North Park Community Center for elderly residents and others with urgent needs.\nN: Now answer the questions.',
    question: 'Who is the bottled water especially intended for?', options: ['Visitors from outside the area', 'Families with school-age children', 'Residents with urgent needs, including older people', 'City workers on the night shift'], correct: 2,
  },
  {
    id: drId('dr_L11a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L11-nurse-handoff.mp3',
    audioText: 'N: Listen to a nurse giving a handoff report to the next shift.\nNurse: Room 204, Mr. Thompson, admitted yesterday with pneumonia. He completed his first dose of IV antibiotics at six p.m. and tolerated it well. His temperature this morning was 37.8, down from 38.5 yesterday. He is still on oxygen at two liters, and his saturation is holding at 96 percent. He can eat soft foods but has had a reduced appetite. The main concern is his mobility — he is at risk of falls, so please ensure the bed alarm is on and assist him to the bathroom. His wife will visit at seven. That is all for now.\nN: Now answer the questions.',
    question: 'Why was Mr. Thompson admitted to the hospital?', options: ['He had a heart condition.', 'He has pneumonia.', 'He broke his leg.', 'He had an allergic reaction.'], correct: 1,
  },
  {
    id: drId('dr_L11b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L11-nurse-handoff.mp3',
    audioText: 'N: Listen to a nurse giving a handoff report to the next shift.\nNurse: Room 204, Mr. Thompson, admitted yesterday with pneumonia. He completed his first dose of IV antibiotics at six p.m. and tolerated it well. His temperature this morning was 37.8, down from 38.5 yesterday. He is still on oxygen at two liters, and his saturation is holding at 96 percent. He can eat soft foods but has had a reduced appetite. The main concern is his mobility — he is at risk of falls, so please ensure the bed alarm is on and assist him to the bathroom. His wife will visit at seven. That is all for now.\nN: Now answer the questions.',
    question: 'What is the main safety concern mentioned by the nurse?', options: ['The patient may have an allergic reaction to the antibiotics.', 'The patient is at risk of falling.', 'The patient\'s oxygen level is too low.', 'The patient refuses to eat.'], correct: 1,
  },
  {
    id: drId('dr_L10a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L10-walking-podcast.mp3',
    audioText: 'N: Listen to part of a podcast.\nHost: When people feel stuck on a problem, they often assume they should stay at their desks and try harder. In fact, short walks can be surprisingly productive. Movement changes your environment and can interrupt repetitive thinking. One design team I interviewed now holds ten-minute walking meetings whenever they cannot agree on a solution. They say the conversations become calmer, and people tend to suggest more creative ideas. Of course, walking is not a replacement for focused work. You still need time to sit down, review options, and make a decision. But if your thinking starts to go in circles, getting up may be exactly what helps.\nN: Now answer the questions.',
    question: 'What is the speaker\'s main point?', options: ['Good ideas only come from group discussions', 'Walking can help people think more effectively', 'Meetings should always take place outdoors', 'Designers are more creative than other workers'], correct: 1,
    teacherNote: 'Target: Main Idea Comprehension. High potential for lapping in "Designers are more creative" if students only listen for keywords.',
  },
  {
    id: drId('dr_L10b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L10-walking-podcast.mp3',
    audioText: 'N: Listen to part of a podcast.\nHost: When people feel stuck on a problem, they often assume they should stay at their desks and try harder. In fact, short walks can be surprisingly productive. Movement changes your environment and can interrupt repetitive thinking. One design team I interviewed now holds ten-minute walking meetings whenever they cannot agree on a solution. They say the conversations become calmer, and people tend to suggest more creative ideas. Of course, walking is not a replacement for focused work. You still need time to sit down, review options, and make a decision. But if your thinking starts to go in circles, getting up may be exactly what helps.\nN: Now answer the questions.',
    question: 'Why does the speaker mention the design team?', options: ['To show an example of the strategy in practice', 'To criticize the way they make decisions', 'To explain why meetings waste time', 'To argue against working at a desk'], correct: 0,
  },
  /* ── Exercise 1: Office relocation ────────────────────────────── */
  {
    id: drId('dr_L13a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L13-office-relocation.mp3',
    audioText: 'Good morning, everyone. As you know, our department is moving to the third floor next Monday. IT staff will disconnect your computers Friday afternoon, so please back up your files before then. The new space has more natural light, but slightly smaller desks, so bring only essential items. Boxes and labels are available at the front desk starting today.',
    question: 'What is the speaker mainly talking about?', options: ['A company merger', 'An office move', 'New computer equipment', 'A change in work hours'], correct: 1,
  },
  {
    id: drId('dr_L13b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L13-office-relocation.mp3',
    audioText: 'Good morning, everyone. As you know, our department is moving to the third floor next Monday. IT staff will disconnect your computers Friday afternoon, so please back up your files before then. The new space has more natural light, but slightly smaller desks, so bring only essential items. Boxes and labels are available at the front desk starting today.',
    question: 'Why does the speaker mention Friday afternoon?', options: ["It's a deadline for saving files", "It's when the meeting ends", "It's the last day of the month", "It's when new desks arrive"], correct: 0,
  },
  {
    id: drId('dr_L13c'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L13-office-relocation.mp3',
    audioText: 'Good morning, everyone. As you know, our department is moving to the third floor next Monday. IT staff will disconnect your computers Friday afternoon, so please back up your files before then. The new space has more natural light, but slightly smaller desks, so bring only essential items. Boxes and labels are available at the front desk starting today.',
    question: 'What should listeners do today?', options: ['Disconnect their computers', 'Get boxes and labels', 'Measure their new desks', 'Submit a request form'], correct: 1,
  },
  /* ── Exercise 2: University guest lecture ─────────────────────── */
  {
    id: drId('dr_L14a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L14-guest-lecture.mp3',
    audioText: 'Before we continue, I want to introduce Dr. Elena Ruiz, a marine biologist who has spent fifteen years studying coral reefs. She will join us for the second half of class to describe her recent fieldwork in the Pacific. I encourage you to prepare questions, since she rarely visits campus and this is a rare chance to ask about a career in marine research.',
    question: 'What is the purpose of this talk?', options: ['To announce a class cancellation', 'To introduce a guest speaker', 'To explain a grading policy', 'To describe a research paper'], correct: 1,
  },
  {
    id: drId('dr_L14b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L14-guest-lecture.mp3',
    audioText: 'Before we continue, I want to introduce Dr. Elena Ruiz, a marine biologist who has spent fifteen years studying coral reefs. She will join us for the second half of class to describe her recent fieldwork in the Pacific. I encourage you to prepare questions, since she rarely visits campus and this is a rare chance to ask about a career in marine research.',
    question: 'Why does the speaker mention that Dr. Ruiz rarely visits campus?', options: ['To explain why students should be prepared', 'To apologize for a scheduling conflict', 'To describe her travel schedule', 'To justify a change in the syllabus'], correct: 0,
  },
  {
    id: drId('dr_L14c'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L14-guest-lecture.mp3',
    audioText: 'Before we continue, I want to introduce Dr. Elena Ruiz, a marine biologist who has spent fifteen years studying coral reefs. She will join us for the second half of class to describe her recent fieldwork in the Pacific. I encourage you to prepare questions, since she rarely visits campus and this is a rare chance to ask about a career in marine research.',
    question: 'What will probably happen next?', options: ['The class will end early', 'Dr. Ruiz will begin speaking', 'Students will take a test', 'The professor will assign homework'], correct: 1,
  },
  /* ── Exercise 3: Museum announcement ──────────────────────────── */
  {
    id: drId('dr_L15a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L15-museum-closure.mp3',
    audioText: 'Attention, visitors: the west wing of the museum will close in fifteen minutes for a private event. If you have not yet seen the ancient pottery exhibit, please head there now, as it is located in that wing. All other galleries remain open until our normal closing time of six o\'clock.',
    question: 'What is being announced?', options: ['A temporary closure', 'A new exhibit opening', 'A ticket price change', 'An emergency evacuation'], correct: 0,
  },
  {
    id: drId('dr_L15b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L15-museum-closure.mp3',
    audioText: 'Attention, visitors: the west wing of the museum will close in fifteen minutes for a private event. If you have not yet seen the ancient pottery exhibit, please head there now, as it is located in that wing. All other galleries remain open until our normal closing time of six o\'clock.',
    question: 'Why does the speaker mention the pottery exhibit?', options: ["It has been moved to another wing", "It is closing along with the west wing", "It is the museum's most popular exhibit", "It requires an additional ticket"], correct: 1,
  },
  {
    id: drId('dr_L15c'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L15-museum-closure.mp3',
    audioText: 'Attention, visitors: the west wing of the museum will close in fifteen minutes for a private event. If you have not yet seen the ancient pottery exhibit, please head there now, as it is located in that wing. All other galleries remain open until our normal closing time of six o\'clock.',
    question: 'What time does the rest of the museum close?', options: ['In fifteen minutes', 'At six o\'clock', 'At the end of the event', 'It stays open all night'], correct: 1,
  },
  /* ── Exercise 4: Workplace training talk ──────────────────────── */
  {
    id: drId('dr_L16a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L16-safety-procedures.mp3',
    audioText: 'Today\'s session covers our updated safety procedures. Notice the new evacuation map posted near the elevators — routes have changed since the renovation. We will also review how to report equipment problems using the new online form instead of paper slips. After this presentation, supervisors will run a short walkthrough of each floor.',
    question: 'What is the speaker mainly discussing?', options: ['Updated safety procedures', 'A company renovation project', 'New hiring policies', 'Building elevator repairs'], correct: 0,
  },
  {
    id: drId('dr_L16b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L16-safety-procedures.mp3',
    audioText: 'Today\'s session covers our updated safety procedures. Notice the new evacuation map posted near the elevators — routes have changed since the renovation. We will also review how to report equipment problems using the new online form instead of paper slips. After this presentation, supervisors will run a short walkthrough of each floor.',
    question: 'What does the speaker say has changed?', options: ['The location of the elevators', 'The evacuation routes', 'The supervisor schedule', 'The office hours'], correct: 1,
  },
  {
    id: drId('dr_L16c'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L16-safety-procedures.mp3',
    audioText: 'Today\'s session covers our updated safety procedures. Notice the new evacuation map posted near the elevators — routes have changed since the renovation. We will also review how to report equipment problems using the new online form instead of paper slips. After this presentation, supervisors will run a short walkthrough of each floor.',
    question: 'What will happen after the presentation?', options: ['Employees will fill out paper slips', 'A walkthrough will take place', 'The building will be evacuated', 'New maps will be printed'], correct: 1,
  },
  /* ── Exercise 5: Science talk on sleep ────────────────────────── */
  {
    id: drId('dr_L17a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    ...
    question: 'What is the talk mainly about?', options: ['Predator behavior in birds', 'A unique sleep ability in birds', 'How birds build nests', 'Bird migration patterns'], correct: 1,
  },
  {
    id: drId('dr_L17b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L17-bird-sleep.mp3',
    audioText: 'Researchers have long wondered how some animals sleep while remaining alert to danger. Certain birds, for instance, can rest one half of their brain at a time, keeping one eye open. This ability, called unihemispheric sleep, helps them watch for predators even while resting. Scientists are now studying whether similar mechanisms might explain sleep patterns in other species.',
    question: 'What does the speaker say about unihemispheric sleep?', options: ["It is found only in one bird species", "It allows partial alertness during rest", "It prevents birds from flying", "It was recently discovered by accident"], correct: 1,
  },
  {
    id: drId('dr_L17c'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L17-bird-sleep.mp3',
    audioText: 'Researchers have long wondered how some animals sleep while remaining alert to danger. Certain birds, for instance, can rest one half of their brain at a time, keeping one eye open. This ability, called unihemispheric sleep, helps them watch for predators even while resting. Scientists are now studying whether similar mechanisms might explain sleep patterns in other species.',
    question: 'What will researchers likely do next?', options: ['Study this ability in other species', 'Publish results about bird migration', 'Build sleep monitors for pets', 'Stop studying animal behavior'], correct: 0,
  },
  /* ── Exercise 6: Health seminar ───────────────────────────────── */
  {
    id: drId('dr_L18a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L18-stress-immune.mp3',
    audioText: 'Many people underestimate how much stress affects the immune system. Chronic stress can increase inflammation and make the body more vulnerable to illness. Simple habits, like regular exercise and consistent sleep schedules, can significantly reduce this risk. Today we will look at a few techniques you can start using this week.',
    question: "What is the speaker's main point?", options: ['Exercise causes stress', 'Stress can weaken the immune system', 'Sleep prevents all illness', 'Inflammation is not related to health'], correct: 1,
  },
  {
    id: drId('dr_L18b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L18-stress-immune.mp3',
    audioText: 'Many people underestimate how much stress affects the immune system. Chronic stress can increase inflammation and make the body more vulnerable to illness. Simple habits, like regular exercise and consistent sleep schedules, can significantly reduce this risk. Today we will look at a few techniques you can start using this week.',
    question: 'Why does the speaker mention exercise and sleep?', options: ['To criticize common habits', 'To suggest ways to reduce stress-related risk', 'To explain a medical study methodology', 'To introduce a new medication'], correct: 1,
  },
  {
    id: drId('dr_L18c'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L18-stress-immune.mp3',
    audioText: 'Many people underestimate how much stress affects the immune system. Chronic stress can increase inflammation and make the body more vulnerable to illness. Simple habits, like regular exercise and consistent sleep schedules, can significantly reduce this risk. Today we will look at a few techniques you can start using this week.',
    question: "What is the speaker's attitude toward the techniques mentioned?", options: ['Skeptical', 'Dismissive', 'Encouraging', 'Neutral'], correct: 2,
  },
  /* ── Exercise 7: Historical lecture ───────────────────────────── */
  {
    id: drId('dr_L19a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L19-printing-press.mp3',
    audioText: 'When the printing press spread across Europe in the fifteenth century, it did not just make books cheaper — it changed how information traveled entirely. Ideas that once took years to reach distant regions could now spread within months. This shift laid the groundwork for widespread literacy and, eventually, for public debate on a scale never seen before.',
    question: 'What is the main topic of this talk?', options: ['The invention of paper', 'The impact of the printing press', 'Literacy rates today', 'The history of European trade'], correct: 1,
  },
  {
    id: drId('dr_L19b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L19-printing-press.mp3',
    audioText: 'When the printing press spread across Europe in the fifteenth century, it did not just make books cheaper — it changed how information traveled entirely. Ideas that once took years to reach distant regions could now spread within months. This shift laid the groundwork for widespread literacy and, eventually, for public debate on a scale never seen before.',
    question: 'According to the speaker, what changed after the printing press spread?', options: ['Books became more expensive', 'Information traveled faster', 'Fewer people learned to read', 'Public debate disappeared'], correct: 1,
  },
  {
    id: drId('dr_L19c'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L19-printing-press.mp3',
    audioText: 'When the printing press spread across Europe in the fifteenth century, it did not just make books cheaper — it changed how information traveled entirely. Ideas that once took years to reach distant regions could now spread within months. This shift laid the groundwork for widespread literacy and, eventually, for public debate on a scale never seen before.',
    question: 'What can be inferred from the talk?', options: ['The printing press had social consequences beyond publishing', 'The printing press was invented in the sixteenth century', 'Literacy declined after the printing press spread', 'Ideas stopped spreading across regions'], correct: 0,
  },
  /* ── Exercise 8: Community center announcement ────────────────── */
  {
    id: drId('dr_L20a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L20-cooking-class.mp3',
    audioText: 'Just a reminder that registration for the summer cooking classes closes this Friday. We have added two new sessions focused on plant-based meals due to high demand. Spaces are limited, so if you are interested, stop by the front office or register online. Do not wait until the last minute, since these classes filled up quickly last year.',
    question: 'What is the announcement mainly about?', options: ['A change in office hours', 'Registration for cooking classes', 'A new community center building', 'A plant-based diet study'], correct: 1,
  },
  {
    id: drId('dr_L20b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L20-cooking-class.mp3',
    audioText: 'Just a reminder that registration for the summer cooking classes closes this Friday. We have added two new sessions focused on plant-based meals due to high demand. Spaces are limited, so if you are interested, stop by the front office or register online. Do not wait until the last minute, since these classes filled up quickly last year.',
    question: 'Why were two new sessions added?', options: ['To replace canceled classes', 'Because of high demand', 'To reduce costs', 'Because of a scheduling conflict'], correct: 1,
  },
  {
    id: drId('dr_L20c'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L20-cooking-class.mp3',
    audioText: 'Just a reminder that registration for the summer cooking classes closes this Friday. We have added two new sessions focused on plant-based meals due to high demand. Spaces are limited, so if you are interested, stop by the front office or register online. Do not wait until the last minute, since these classes filled up quickly last year.',
    question: 'Why does the speaker mention last year?', options: ['To explain why classes were canceled', 'To warn people not to wait too long', 'To describe a past event', 'To compare prices'], correct: 1,
  },
  /* ── Exercise 9: Corporate presentation ───────────────────────── */
  {
    id: drId('dr_L21a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L21-online-ordering.mp3',
    audioText: 'Our sales numbers this quarter exceeded expectations, largely due to the new online ordering system. Customers reported the checkout process felt faster and more reliable. Looking ahead, we plan to expand this system to our international stores by early next year, starting with our locations in Canada and Mexico.',
    question: 'What is the speaker mainly discussing?', options: ['A decline in sales', 'The success of a new ordering system', 'A change in store locations', 'Customer complaints'], correct: 1,
  },
  {
    id: drId('dr_L21b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L21-online-ordering.mp3',
    audioText: 'Our sales numbers this quarter exceeded expectations, largely due to the new online ordering system. Customers reported the checkout process felt faster and more reliable. Looking ahead, we plan to expand this system to our international stores by early next year, starting with our locations in Canada and Mexico.',
    question: 'Why does the speaker mention Canada and Mexico?', options: ['They are where sales have declined', 'They will be the first international expansion sites', 'They no longer use the online system', 'They are opening new physical stores'], correct: 1,
  },
  {
    id: drId('dr_L21c'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L21-online-ordering.mp3',
    audioText: 'Our sales numbers this quarter exceeded expectations, largely due to the new online ordering system. Customers reported the checkout process felt faster and more reliable. Looking ahead, we plan to expand this system to our international stores by early next year, starting with our locations in Canada and Mexico.',
    question: "What is the speaker's attitude about the new system?", options: ['Doubtful', 'Positive', 'Indifferent', 'Confused'], correct: 1,
  },
  /* ── Exercise 10: Environmental talk ──────────────────────────── */
  {
    id: drId('dr_L22a'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L22-urban-gardens.mp3',
    audioText: 'Urban gardens do more than provide fresh produce — they also help cool neighborhoods during heat waves. Plants absorb sunlight and release moisture, which lowers surrounding temperatures. Cities that have invested in these gardens report measurable drops in local temperatures during summer months, along with improved air quality.',
    question: 'What is the main idea of the talk?', options: ['Urban gardens are difficult to maintain', 'Urban gardens offer benefits beyond food production', 'Heat waves are becoming more frequent', 'Air quality is unrelated to plants'], correct: 1,
  },
  {
    id: drId('dr_L22b'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L22-urban-gardens.mp3',
    audioText: 'Urban gardens do more than provide fresh produce — they also help cool neighborhoods during heat waves. Plants absorb sunlight and release moisture, which lowers surrounding temperatures. Cities that have invested in these gardens report measurable drops in local temperatures during summer months, along with improved air quality.',
    question: 'According to the speaker, how do plants lower temperatures?', options: ['By blocking sunlight completely', 'By absorbing sunlight and releasing moisture', 'By reducing the number of buildings', 'By increasing humidity indoors'], correct: 1,
  },
  {
    id: drId('dr_L22c'), type: 'listen', level: 'B2', skill: 'listening', plays: 2,
    audioSrc: '/exercises/audio/listening/listening-L22-urban-gardens.mp3',
    audioText: 'Urban gardens do more than provide fresh produce — they also help cool neighborhoods during heat waves. Plants absorb sunlight and release moisture, which lowers surrounding temperatures. Cities that have invested in these gardens report measurable drops in local temperatures during summer months, along with improved air quality.',
    question: 'What do cities with urban gardens report?', options: ['Higher costs', 'Lower temperatures and better air quality', 'Fewer public parks', 'Increased heat waves'], correct: 1,
  },
];
...
const READING = [
  ...
  {
    id: drId('dr_R12'), type: 'read', level: 'B2', skill: 'reading',
    source: 'Original context - Register focus',
    passage: 'Text A: Official Memo\\nTo: All Nursing Staff\\nFrom: Hospital Administration\\nDate: October 12\\nSubject: Updated Protocol for Patient Handoffs\\n\\nEffective immediately, all staff must utilize the SBAR framework for every patient transfer. This standardized approach is essential to ensure patient safety and minimize the risk of clinical error. Please review the attached guidelines and sign the acknowledgment form by Friday.',
    questions: [
      { id: drId('drq'), question: 'What is the primary purpose of Text A?', options: ['To invite staff to a meeting', 'To implement a mandatory safety protocol', 'To praise the nursing staff', 'To announce a holiday'], correct: 1 },
      { id: drId('drq'), question: 'Which word best describes the register of Text A?', options: ['Informal', 'Casual', 'Formal', 'Aggressive'], correct: 2 },
      { id: drId('drq'), question: 'What is the consequence of not following the protocol according to the text?', options: ['A fine will be issued', 'Risk of clinical error', 'The hospital will close', 'Staff will be retrained'], correct: 1 },
    ],
  },
  {
    id: drId('dr_R13'), type: 'read', level: 'B2', skill: 'reading',
    source: 'Original context - Register focus',
    passage: 'Text B: WhatsApp message between colleagues\\nNurse Sarah: Hey Jen! Did you see the new SBAR thing? Total pain to fill out, but the boss is obsessed with it lol. Just lemme know if you need help with the form. See ya!',
    questions: [
      { id: drId('drq'), question: 'How does Sarah feel about the new protocol?', options: ['She is excited', 'She finds it tedious', 'She thinks it is useless', 'She is confused by it'], correct: 1 },
      { id: drId('drq'), question: 'What is the register of Text B?', options: ['Formal', 'Informal', 'Professional', 'Academic'], correct: 1 },
      { id: drId('drq'), question: 'Which phrase in Text B is most inappropriate for a formal memo?', options: ['Total pain', ' la la l la', 'Let me know', 'See ya!'], correct: 0 },
    ],
  },
  {
    id: drId('dr_R14'), type: 'read', level: 'B2', skill: 'reading',
    source: 'Original context - Integrated Grammar',
    passage: 'The recent shift toward telemedicine has changed the way patients interact with specialists. Had the technology been available a decade ago, many rural patients would have avoided long journeys to the city. While some argue that digital consultations lack the personal touch of a physical visit, others maintain that the efficiency gains outweigh the loss of face-to-face contact. Consequently, many clinics are now adopting a hybrid model, where the first appointment is in-person and follow-ups are conducted online.',
    questions: [
      { id: drId('drq'), question: 'What is the meaning of "Had the technology been available a decade ago..."?', options: ['The technology was available then', 'The technology was not available then', 'The technology is still not available', 'The technology only worked in cities'], correct: 1 },
      { id: drId('drq'), question: 'Which grammatical structure is used to express the hypothetical past in the second sentence?', options: ['First Conditional', 'Second Conditional', 'Third Conditional', 'Zero Conditional'], correct: 2 },
      { id: drId('drq'), question: 'What is the author\'s main conclusion about the hybrid model?', options: ['It is less efficient than telemedicine', 'It combines the benefits of both in-person and digital visits', 'It is only useful for rural patients', 'It should be replaced by full telemedicine'], correct: 1 },
    ],
  },
...
const SPEAKING = [
  {
    id: drId('dr_S01'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q1',
    imageUrl: 'https://i.ibb.co/GfvjStXV/Chat-GPT-Image-23-de-jun-de-2026-20-39-04.png',
    imageAlt: 'Two people assembling a bookshelf in a small apartment, boxes on the floor, one reading a manual',
  ...
  {
    id: drId('dr_S02'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q1',
    imageUrl: 'https://i.ibb.co/5XsD0fMT/Chat-GPT-Image-23-de-jun-de-2026-20-38-48.png',
    imageAlt: 'A group of people waiting for a bus in heavy rain, with one person sharing an umbrella with another',
    prompt: 'Look at the picture. Describe what you see.',
    targetSeconds: 60,
  ...
  {
    id: drId('dr_S12'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q1',
    imageUrl: 'https://i.ibb.co/cKn7nng4/89e01f31-5c8b-4940-b807-2e175a69c817.png',
    imageAlt: 'A healthcare professional showing a digital tablet to an older patient in a clinic',
    prompt: 'Look at the picture. Describe what you see.',
    targetSeconds: 60,
    scaffolding: { vocabulary: ['clinic', 'patient', 'healthcare', 'tablet', 'consultation', 'professional'], structure: ['Describe the setting and people', 'Describe what they are doing', 'Add inference about the situation', 'Give overall impression'] },
    note: 'Sample response (45-60s): In this picture, I can see a healthcare professional and an older patient in a modern clinic. The professional, who is wearing a white coat, is holding a digital tablet and showing something to the patient, who is sitting on an examination table. They both look focused on the screen, which suggests they are discussing medical results or a treatment plan. The room is bright and contains various medical equipment in the background. Overall, the image depicts a professional and calm consultation between a provider and a patient.',
  },
  {
    id: drId('dr_S13'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q1',
    imageUrl: '/images/met/speaking/s04-park-scene.png',
    imageAlt: 'A park scene with people walking, children playing, trees and a pond in a city setting',
    prompt: 'Look at the picture. Describe what you see.',
    targetSeconds: 60,
    scaffolding: { vocabulary: ['park', 'relax', 'nature', 'activity', 'peaceful', 'community'], structure: ['Describe the setting and weather', 'Describe the people and activities', 'Make an inference about the mood', 'Conclude with overall impression'] },
    note: 'Sample response (45-60s): This picture shows a public park on what appears to be a pleasant day. Several people are enjoying the space — some are walking along the paths, others are sitting on benches, and a few children are playing on the grass. There are trees and a pond, which give the scene a calm and natural atmosphere despite being in a city. The mood seems relaxed and friendly. Overall, this picture illustrates how green spaces offer people a place to rest, exercise, and connect with each other.',
  },
  {
    id: drId('dr_S14'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q1',
    imageUrl: '/images/met/speaking/s05-classroom.png',
    imageAlt: 'A classroom with students working in groups, a teacher helping one group, boards with notes',
    prompt: 'Look at the picture. Describe what you see.',
    targetSeconds: 60,
    scaffolding: { vocabulary: ['classroom', 'students', 'collaborate', 'teacher', 'discussion', 'learning'], structure: ['Describe the setting and people', 'Describe what they are doing', 'Add inference about the situation', 'Give overall impression'] },
    note: 'Sample response (45-60s): This picture shows a modern classroom where several students are working in small groups. The room contains desks arranged in clusters, boards with notes and diagrams, and natural light coming through windows. A teacher is standing near one group, explaining something or answering questions. The students appear focused and engaged in a collaborative activity. This picture gives the impression of an interactive learning environment where students are encouraged to discuss ideas and solve problems together.',
  },
  {
    id: drId('dr_S15'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q1',
    imageUrl: '/images/met/speaking/s06-market.png',
    imageAlt: 'An outdoor market with stalls selling fresh fruit and vegetables, people shopping and vendors',
    prompt: 'Look at the picture. Describe what you see.',
    targetSeconds: 60,
    scaffolding: { vocabulary: ['market', 'fresh', 'stall', 'vendor', 'shopping', 'colourful'], structure: ['Describe the setting and atmosphere', 'Describe the stalls and products', 'Describe the people and actions', 'Conclude with overall impression'] },
    note: 'Sample response (45-60s): This picture shows an outdoor market with several stalls selling fresh fruit and vegetables. The products are colourful and arranged neatly, which makes the scene feel lively and inviting. Vendors are standing behind their stalls, and customers are walking through, stopping to look, touch, and buy. The atmosphere seems busy but friendly, with people chatting and negotiating in a relaxed way. This kind of market likely represents a local community where people prefer fresh, seasonal food over supermarket shopping.',
  },
  {
    id: drId('dr_S03'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q2',
  ...
  {
    id: drId('dr_S04'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q2',
  ...
  {
    id: drId('dr_S05'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q3',
  ...
  {
    id: drId('dr_S06'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q3',
  ...
  {
    id: drId('dr_S07'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q4',
  ...
  {
    id: drId('dr_S08'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q4',
  ...
  {
    id: drId('dr_S09'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q5',
  ...
  {
    id: drId('dr_S10'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q5',
  ...
  {
    id: drId('dr_S11'), type: 'speak', level: 'B2', skill: 'speaking', metTask: 'Q5',
...
const GRAMMAR = [
  {
    id: drId('dr_G01a'), type: 'mcq', level: 'B2', skill: 'grammar',
    question: 'By the time we arrived, the meeting ______.',
    options: ['already finished', 'has already finished', 'had already finished', 'was already finishing'], correct: 2,
  },
  {
    id: drId('dr_G01b'), type: 'mcq', level: 'B2', skill: 'grammar',
    question: 'She apologized ______ replying so late.',
    options: ['for', 'of', 'about', 'to'], correct: 0,
  },
  {
    id: drId('dr_G01c'), type: 'mcq', level: 'B2', skill: 'grammar',
    question: 'If I ______ more free time, I\'d join the evening course.',
    options: ['have', 'had', 'would have', 'will have'], correct: 1,
  },
  {
    id: drId('dr_G01d'), type: 'mcq', level: 'B2', skill: 'grammar',
    question: 'The manager suggested ______ the decision until Monday.',
    options: ['to delay', 'delaying', 'delay', 'delayed'], correct: 1,
  },
  {
    id: drId('dr_G01e'), type: 'mcq', level: 'B2', skill: 'grammar',
    question: 'This is the shop ______ I bought my laptop.',
    options: ['which', 'where', 'who', 'whose'], correct: 1,
  },
  {
  ...
  {
    id: drId('dr_G08a'), type: 'mcq', level: 'B2', skill: 'grammar',
    question: 'You ______ bring your ID; they won\'t let you in without it.',
    options: ['must', 'might', 'could', 'don\'t have to'], correct: 0,
  },
  {
    id: drId('dr_G08b'), type: 'mcq', level: 'B2', skill: 'grammar',
    question: 'She looks exhausted. She ______ have slept very little.',
    options: ['can\'t', 'must', 'should', 'might not'], correct: 1,
  },
  {
    id: drId('dr_G08c'), type: 'mcq', level: 'B2', skill: 'grammar',
    question: 'They ______ have taken the earlier train; they\'re already here.',
    options: ['must', 'can\'t', 'shouldn\'t', 'could'], correct: 0,
  },
  {
    id: drId('dr_G08d'), type: 'mcq', level: 'B2', skill: 'grammar',
    question: 'You ______ smoke here; it\'s against the rules.',
    options: ['don\'t have to', 'mustn\'t', 'needn\'t', 'won\'t'], correct: 1,
  },
  {
    id: drId('dr_G08e'), type: 'mcq', level: 'B2', skill: 'grammar',
    question: 'We ______ meet tomorrow if you\'re free, but it isn\'t final yet.',
    options: ['must', 'should', 'might', 'have to'], correct: 2,
  },
  {
...
const MODULES = [
  ...
  { id: 'dr_speaking', label: 'MET B2 — Speaking', skill: 'speaking', level: 'B2', note: '16 tasks across all 5 MET task types (Q1–Q5) with images', exercises: SPEAKING },
...
export const deepResearchMeta = {
  ...
  title: 'MET B2 Extended Practice Pack',
  subtitle: '53 exam-style exercises',
  level: 'B2',
