...
export const UNITS_6_TO_10: PracticeUnit[] = [
  {
    ...
    listening: {
      ...
      type: "Interview",
      script: [
        { id: 1, speaker: "Interviewer", text: "You changed your morning routine last year. What was the biggest difference?" },
        { id: 2, speaker: "Guest", text: "I stopped checking my phone as soon as I woke up. At first, it felt strange because I was used to reading messages in bed." },
        { id: 3, speaker: "Interviewer", text: "What do you do instead?" },
        { id: 4, speaker: "Guest", text: "I drink water, stretch for five minutes, and write down the three most important things I need to do. It sounds simple, but it helps me start the day calmly." },
        { id: 5, speaker: "Interviewer", text: "Did it improve your productivity?" },
        { id: 6, speaker: "Guest", text: "Yes, but not magically. I still have busy days. The main benefit is that I feel more in control before other people's messages enter my mind." }
      ],
      questions: [
        {
          id: 1,
