...
type MainPage = 'overview' | 'syllabus' | 'student' | 'teacher' | 'progress' | 'messages';
...
export default function App() {
    ...
    return (
      <div className="space-y-8 select-none">
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-stretch">
          ...
          {/* Main Hero Card */}
          <div className="xl:col-span-8 bg-white p-6 sm:p-8 rounded-2xl border border-[#d8e6e6] shadow-3xs flex flex-col justify-between">
            <div className="space-y-4">
              <span className="text-xs font-extrabold text-[#2d8b8b] tracking-wider uppercase font-mono">
                Your pathway to MET confidence
              </span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-[#1a2332] tracking-tight leading-tight">
                A serious preparation space <br className="hidden sm:inline" /> for adult healthcare learners.
              </h2>
              <p className="text-sm sm:text-base text-[#607380] leading-relaxed max-w-2xl font-normal">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8">
              <div className="bg-[#f4f8f8] p-4 rounded-xl border border-[#d8e6e6]/60">
                <span className="block text-2xl font-black text-[#1a2332] font-mono leading-none">{completedPercent}%</span>
                <span className="block text-[10px] text-[#607380] font-bold uppercase mt-2 font-mono">MET Syllabus Progress</span>
              </div>
              <div className="bg-[#f4f8f8] p-4 rounded-xl border border-[#d8e6e6]/60">
                <span className="block text-2xl font-black text-[#2d8b8b] font-mono leading-none">30%</span>
                <span className="block text-[10px] text-[#607380] font-bold uppercase mt-2 font-mono">Healthcare focus</span>
              </div>
              <div className="bg-[#f4f8f8] p-4 rounded-xl border border-[#d8e6e6]/60">
                <span className="block text-2xl font-black text-[#1a2332] font-mono leading-none">58 / 59</span>
                <span className="block text-[10px] text-[#607380] font-bold uppercase mt-2 font-mono">Healthcare Goal</span>
              </div>
              <div className="bg-[#f4f8f8] p-4 rounded-xl border border-[#d8e6e6]/60">
                <span className="block text-2xl font-black text-amber-600 font-mono leading-none">{streakCount} Days</span>
                <span className="block text-[10px] text-[#607380] font-bold uppercase mt-2 font-mono">Study Goal Streak</span>
              </div>
            </div>
          </div>

          {/* Right Sidebar Next Class Card */}
          <div className="xl:col-span-4 bg-[#1a2332] p-6 rounded-2xl border border-white/10 text-white flex flex-col justify-between shadow-md">
            <div>
              <span className="text-[10px] font-extrabold text-[#a8dadc] tracking-widest uppercase font-mono block mb-3">
                Next Live Training
              </span>
              <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-2">
                <h3 className="font-bold text-base leading-snug">Speaking Q4: Organise Clinical Opinions</h3>
            ...
            <div className="grid grid-cols-3 gap-2.5 mt-6 pt-6 border-t border-white/5">
              <div className="bg-white/5 border border-white/10 rounded-xl p-3 text-center">
                ...
                <span className="block text-[9px] text-[#a8dadc] font-bold mt-1 uppercase font-mono leading-tight">Units left</span>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-xl p-3 text-center">
                <span className="block text-xs font-semibold text-white leading-tight py-0.5">
                  {feedbackApproved ? 'APPROVED' : 'PENDING'}
                </span>
                <span className="block text-[9px] text-slate-400 font-medium mt-1 uppercase font-mono leading-tight">Feedback</span>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-xl p-3 text-center flex flex-col justify-center items-center">
                ...
                <span className="block text-[9px] text-slate-400 font-medium mt-1 uppercase font-mono leading-tight">Goal state</span>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-extrabold text-[#1a2332] tracking-tight">Evidence-Based Clinical Flow</h3>
            <p className="text-xs text-[#607380] font-normal leading-relaxed mt-0.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={step.num} className="bg-white p-5 rounded-xl border border-[#d8e6e6] shadow-3xs space-y-3">
                <div className="w-8 h-8 rounded-lg bg-[#1a2332] text-[#e4f2f2] font-black text-sm flex items-center justify-center font-mono">
                  {step.num}
                </div>
                <div>
                  <h4 className="font-bold text-sm text-[#1a2332]">{step.title}</h4>
                  <p className="text-xs text-[#607380] leading-relaxed mt-1 font-sans">{step.desc}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-white rounded-xl border border-[#d8e6e6] p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3 text-left">
              <div className="p-2.5 bg-[#e4f2f2] text-[#2d8b8b] rounded-lg border border-[#b8dede]">
                <GraduationCap className="w-5 h-5" />
              </div>
              <div>
                <p className="text-xs font-mono font-bold text-[#2d8b8b] uppercase tracking-wider">Are you ready to practice?</p>
                <p className="text-xs text-[#607380] font-normal mt-0.5 font-sans">Explore our intensive practice modules across 10 immersive lessons.</p>
              </div>
            </div>
            <button
              onClick={() => setActiveMainPage('syllabus')}
              className="px-4 py-2 bg-[#1a2332] hover:bg-[#2d8b8b] text-white text-xs font-extrabold rounded-lg transition-all shadow-3xs flex items-center gap-1 shrink-0 cursor-pointer"
            >
    ...
    return (
      <div className="space-y-8">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-extrabold text-[#1a2332] tracking-tight">Active Clinical Focus</h3>
            <p className="text-xs text-[#607380] font-normal leading-relaxed mt-0.5">
              Personalized instructions assigned specifically for your CEFR proficiency grade
            </p>
          </div>
          <span className="bg-[#cbdada]/50 text-[#2d8b8b] border border-[#2d8b8b]/30 text-[10px] font-mono tracking-widest px-2 py-0.5 rounded font-extrabold uppercase select-none">
            {feedbackApproved ? 'Clinician Verified' : 'Standard Baseline'}
          </span>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-xl border border-[#d8e6e6] shadow-3xs flex flex-col justify-between space-y-4">
            <div className="space-y-1.5 text-left">
              <span className="text-[10px] text-[#2d8b8b] uppercase tracking-wider font-extrabold font-mono block">Today's active focus</span>
              <h3 className="font-extrabold text-base text-[#1a2332] leading-snug">Organize speaking answers</h3>
              <p className="text-xs text-[#607380] leading-relaxed font-sans">{feedbacks.todayFocus}</p>
            </div>
            <div className="flex gap-2">
              <span className="bg-[#e4f2f2] text-[#2d8b8b] px-2 py-0.5 text-[9px] font-mono font-bold uppercase rounded">Speaking</span>
              <span className="bg-slate-100 text-slate-500 px-2 py-0.5 text-[9px] font-mono font-bold uppercase rounded">Q4 clinical opinion</span>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-[#d8e6e6] shadow-3xs flex flex-col justify-between space-y-4">
            <div className="space-y-1.5 text-left">
              ...
              <h3 className="font-extrabold text-base text-[#1a2332] leading-snug">Syntactic structures & evidence</h3>
              <p className="text-xs text-[#607380] leading-relaxed font-sans">{feedbacks.whatIsStronger}</p>
            </div>
            <div>
          ...
          <div className="bg-white p-6 rounded-xl border border-[#d8e6e6] shadow-3xs flex flex-col justify-between space-y-4">
            <div className="space-y-1.5 text-left">
              ...
              <h3 className="font-extrabold text-base text-[#1a2332] leading-snug">Plan before answering</h3>
              <p className="text-xs text-[#607380] leading-relaxed font-sans">{feedbacks.nextStep}</p>
            </div>
            <div>
        ...
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-extrabold text-[#1a2332] tracking-tight">Assigned Homework</h3>
            <p className="text-xs text-[#607380] font-normal leading-relaxed mt-0.5">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={hw.idx} className="bg-white p-5 rounded-xl border border-[#d8e6e6] shadow-3xs flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-start gap-4 text-left">
                  <div className="w-10 h-10 rounded-lg bg-[#e4f2f2] text-[#2d8b8b] flex items-center justify-center font-black text-sm font-mono shrink-0 select-none">
                    {hw.idx}
                  </div>
                  <div>
                    <h4 className="font-extrabold text-sm text-[#1a2332]">{hw.title}</h4>
                    <p className="text-xs text-[#607380] leading-relaxed mt-1 font-sans max-w-2xl">{hw.desc}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 self-end md:self-auto">
                  <span className={`text-[9px] font-mono font-bold px-2 py-0.5 rounded border uppercase select-none ${
                    hw.tag.toLowerCase().includes('ready')
                      ? 'bg-teal-50 border-teal-200 text-[#2d8b8b]'
                  ...
                  <button
                    ...
                    className="px-3.5 py-2 hover:bg-[#cbdada]/50 border border-[#cbdada] text-[#1a2332] text-[11px] font-bold rounded-lg transition-all flex items-center gap-1 cursor-pointer select-none font-mono uppercase"
                  >
                    <span>{hw.cta}</span>
      ...
      <div className="space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="text-left">
            <h3 className="text-lg font-extrabold text-[#1a2332] tracking-tight">Teacher Diagnostic Console</h3>
            <p className="text-xs text-[#607380] font-normal leading-relaxed mt-0.5">
          ...
          <button
            ...
            className="px-4 py-2 bg-[#2d8b8b] hover:bg-[#247070] text-white text-xs font-extrabold rounded-xl transition-all shadow-3xs flex items-center justify-center gap-1.5 cursor-pointer active:scale-97 text-center select-none"
          >
            <CheckSquare className="w-4 h-4 text-[#e4f2f2]" />
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-stretch">
          ...
          {/* Sliders panel */}
          <div className="xl:col-span-6 bg-white p-6 rounded-2xl border border-[#d8e6e6] shadow-sm flex flex-col justify-between space-y-6">
            <div className="text-left">
              <span className="text-[10px] font-extrabold text-[#2d8b8b] tracking-wider uppercase font-mono block mb-4 select-none">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={slider.key} className="space-y-1.5">
                    <div className="flex items-center justify-between text-xs font-semibold text-[#1a2332]">
                      ...
                      <span className={`text-[10px] font-mono font-bold px-1.5 py-0.5 rounded border uppercase select-none ${
                        slider.val === 0 ? 'bg-amber-50 border-amber-100 text-amber-700' : 'bg-teal-50 border-teal-100 text-[#2d8b8b]'
                      }`}>
                    ...
                    <div className="flex items-center gap-4">
                      <input
                        ...
                        className="grow accent-[#2d8b8b] h-1 bg-slate-100 rounded-lg appearance-none cursor-pointer"
                      />
                    </div>
                  </div>
                ))}
            ...
            <div className="bg-[#f0f8f7] border-l-4 border-[#2d8b8b] p-4 rounded-r-lg space-y-2 mt-4 text-left">
              <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-[#247070] block select-none">Clinician Assessment Logging</span>
              <textarea
                value={teacherNote}
                onChange={(e) => setTeacherNote(e.target.value)}
                className="w-full text-xs text-[#1f2d3a] bg-white border border-[#cbdada] rounded p-2.5 leading-relaxed focus:outline-none focus:border-[#2d8b8b] resize-none h-[110px]"
          ...
          <div className="xl:col-span-6 bg-white p-6 rounded-2xl border border-[#d8e6e6] shadow-sm space-y-5 text-left">
            <span className="text-[10px] font-extrabold text-[#2d8b8b] tracking-wider uppercase font-mono block select-none">
            ...
            <div className="space-y-3.5">
              {[
                ...
                <div key={feedbackField.label} className="space-y-1">
                  <label className="text-[10px] font-bold text-[#607380] uppercase tracking-wider font-mono select-none">{feedbackField.label}</label>
                  <textarea
                    value={feedbackField.val}
                    onChange={(e) => {
                      feedbackField.setter(e.target.value);
                    }}
                    className="w-full text-xs text-[#1f2d3a] p-2 bg-slate-50 rounded border border-slate-205 focus:outline-none focus:border-[#2d8b8b] leading-relaxed resize-none h-[54px]"
  ...
  const renderProgressPage = () => {
    ...
    return (
      <div className="space-y-8">
        <div className="text-left">
          <h3 className="text-lg font-extrabold text-[#1a2332] tracking-tight">MET English Proficiency scorecard</h3>
          <p className="text-xs text-[#607380] font-normal leading-relaxed mt-0.5">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-stretch">
          ...
          {/* Progress Card */}
          <div className="xl:col-span-7 bg-white p-6 rounded-2xl border border-[#d8e6e6] shadow-sm space-y-6">
            <span className="text-[10px] font-extrabold text-[#2d8b8b] tracking-wider uppercase font-mono block text-left select-none">
              CEFR Verification Path
            </span>

            <div className="divide-y divide-[#cbdada]/20 space-y-4">
              {[
                ...
                return (
                  <div key={skillRow.label} className="pt-4 first:pt-0 grid grid-cols-1 sm:grid-cols-12 items-center gap-3 text-left">
                    <div className="sm:col-span-4 text-xs font-semibold text-[#1a2332]">
                      {skillRow.label}
                    </div>
                    <div className="sm:col-span-5">
                      <div className="h-2.5 overflow-hidden rounded-full bg-slate-100 border border-slate-200/50 flex">
                        <div
                          style={{ width: `${percent}%` }}
                          className="h-full bg-[#2d8b8b] rounded-full transition-all duration-300"
                        />
                      </div>
                    </div>
                    <div className="sm:col-span-3 text-right flex items-center justify-end gap-2">
                      <span className="text-[10px] font-mono font-bold text-[#1f2d3a] select-none">
                        {percent}%
                      </span>
                      <span className={`text-[9px] font-mono font-bold uppercase px-2 py-0.5 rounded border leading-none select-none ${
                        percent === 0 
                          ...
                          : 'bg-teal-50 border-teal-100 text-[#2d8b8b]'
                      }`}>
                        {skillRow.tag}
                      </span>
                    </div>
          ...
          <div className="xl:col-span-5 bg-white p-6 rounded-2xl border border-[#d8e6e6] shadow-sm space-y-6">
            <span className="text-[10px] font-extrabold text-[#2d8b8b] tracking-wider uppercase font-mono block text-left select-none">
            ...
            <div className="space-y-4 text-left">
              ...
              {speakingDraft && speakingDraft.trim() !== '' && (
                <div className="grid grid-cols-12 items-start gap-3 border-b border-dashed border-slate-150 pb-3">
                  <div className="col-span-3 text-[10px] font-mono text-[#607380] font-bold uppercase leading-tight select-none">
                    Jun 8, 2026
                  </div>
                  <div className="col-span-9 space-y-1">
                    <p className="font-extrabold text-xs text-[#1a2332]">Speaking Sample Logged</p>
                    <p className="text-[11px] text-[#657b8c] leading-relaxed italic line-clamp-2">
                      "{speakingDraft}"
                    </p>
                  </div>
                </div>
              ...
              {writingContent && writingContent.trim() !== '' && (
                <div className="grid grid-cols-12 items-start gap-3 border-b border-dashed border-slate-150 pb-3">
                  ...
                  <div className="col-span-9 space-y-1">
                    <p className="font-extrabold text-xs text-[#1a2332]">Essay Composition Submission</p>
                    <p className="text-[11px] text-[#657b8c] leading-relaxed italic line-clamp-2">
                      "{writingContent}"
                    </p>
                  </div>
              ...
              <div className="grid grid-cols-12 items-start gap-3">
                ...
                <div className="col-span-9 space-y-1">
                  <p className="font-extrabold text-xs text-[#1a2332]">Oral Check-in Speaking Dialogue</p>
                  <p className="text-[11px] text-[#657b8c] leading-relaxed">
              ...
              <div className="grid grid-cols-12 items-start gap-3">
                ...
                <div className="col-span-9 space-y-1">
                  <p className="font-extrabold text-xs text-[#1a2332]">Homework Review Approved</p>
                  <p className="text-[11px] text-[#657b8c] leading-relaxed">
              ...
              <div className="grid grid-cols-12 items-start gap-3">
                ...
                <div className="col-span-9 space-y-1">
                  <p className="font-extrabold text-xs text-[#1a2332]">Listening Practice Diagnostic</p>
                  <p className="text-[11px] text-[#657b8c] leading-relaxed">
  ...
  const renderMessagesPage = () => {
    return (
      <div className="space-y-8 select-none">
        <div className="text-left">
          <h3 className="text-lg font-extrabold text-[#1a2332] tracking-tight">Clinical Announcements & Communications</h3>
          <p className="text-xs text-[#607380] font-normal leading-relaxed mt-0.5">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-stretch">
          ...
          {/* Message Inbox list */}
          <div className="xl:col-span-7 bg-white p-6 rounded-2xl border border-[#d8e6e6] shadow-sm flex flex-col justify-between h-full space-y-6">
            <div className="space-y-4 text-left">
              <span className="text-[10px] font-extrabold text-[#2d8b8b] tracking-wider uppercase font-mono block">
                ...
                {messages.map((msg) => (
                  <div
                    ...
                    className={`p-3.5 rounded-xl text-xs space-y-1 max-w-[85%] ${
                      msg.sender === 'student'
                        ? 'bg-[#e4f2f2]/40 text-[#1f2d3a] mr-auto border border-[#cbdada]/40'
                        : 'bg-[#1a2332] text-white ml-auto'
                    }`}
                  >
            ...
            <div className="space-y-3 pt-3 border-t border-slate-100">
              <textarea
                ...
                className="w-full text-xs text-[#1f2d3a] p-2.5 bg-slate-50 border border-[#cbdada] rounded-lg focus:outline-none focus:ring-1 focus:ring-[#2d8b8b] leading-relaxed resize-none h-[82px]"
              />
              <button
                onClick={() => {
                ...
                className="w-full py-2 bg-[#2d8b8b] hover:bg-[#247070] text-white text-xs font-bold rounded-lg transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-3xs"
              >
                <Send className="w-3.5 h-3.5 shrink-[#1a2332]" />
          ...
          <div className="xl:col-span-5 bg-white p-6 rounded-2xl border border-[#d8e6e6] shadow-sm space-y-4">
            <span className="text-[10px] font-extrabold text-[#2d8b8b] tracking-wider uppercase font-mono block mb-2 text-left">
              Clinical Bulletin Board
            </span>

            <div className="space-y-4 max-h-[440px] overflow-y-auto pr-1 text-left">
              {announcements.map((ann) => (
                <div key={ann.id} className="p-4 bg-slate-50/50 rounded-xl border border-slate-205/60 space-y-2">
                  <div className="flex items-center gap-2">
                    <div className="p-1 px-1.5 bg-[#e4f2f2] text-[#2d8b8b] rounded text-[8px] font-mono uppercase tracking-widest font-black select-none">
                      Tip
                    </div>
                    <strong className="text-xs text-[#1a2332] font-extrabold block">{ann.title}</strong>
                  </div>
                  <p className="text-[11px] text-[#607380] leading-relaxed font-sans">{ann.content}</p>
                </div>
              ))}
            </div>
          </div>
  ...
  return (
    <div id="full-dashboard-layout" className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-between selection:bg-emerald-100 selection:text-[#1a2332] font-sans">
      
      {/* Dynamic Master Top Navigation Header - Dedicated MET Proficiency Study Hub */}
      <header className="bg-white border-b border-[#cbdada]/50 sticky top-0 z-40 shadow-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex flex-col lg:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#1a2332] flex items-center justify-center text-white font-sans shadow-md">
              <span className="font-extrabold text-base tracking-tighter">MET</span>
            </div>
            <div className="text-left">
              <h1 className="text-sm sm:text-base font-extrabold tracking-tight text-slate-950 flex items-center gap-1.5 leading-none">
                MET Proficiency Mastery <span className="bg-[#e4f2f2] text-[10px] text-[#2d8b8b] border border-[#cbdada]/60 px-2 py-0.5 rounded-full font-mono font-bold uppercase">Clinician Portal</span>
              </h1>
              <p className="text-[10px] text-slate-400 font-mono mt-1 uppercase tracking-wider font-semibold">Interactive Michigan English Test Preparation</p>
            </div>
          </div>

          {/* Master Top Page Navigator */}
          <div className="flex items-center gap-0.5 bg-slate-100/80 p-1 rounded-xl border border-slate-200/50 max-w-full overflow-x-auto select-none no-scrollbar">
            {[
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-[11px] font-bold font-sans flex items-center gap-1.5 transition-all select-none whitespace-nowrap cursor-pointer ${
                    active
                      ? 'bg-[#1a2332] text-white shadow-xs'
                      : 'text-[#607380] hover:text-[#1a2332] hover:bg-slate-200/60'
                  }`}
                >
                  <Icon className={`w-3.5 h-3.5 ${active ? 'text-[#e4f2f2]' : 'text-slate-400'}`} />
                  <span>{tab.label}</span>
                </button>
              );
            })}
          ...
          <div className="hidden xl:flex items-center gap-3">
            <button
              ...
              className="px-3 py-2 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-[10px] font-extrabold flex items-center gap-1.5 cursor-pointer shadow-xs transition-all active:scale-97 select-none font-mono uppercase"
          ...
          {(() => {
            ...
            return (
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="flex items-center gap-4 bg-white p-4 rounded-2xl border border-slate-200/80 shadow-3xs">
                  <div className="relative flex items-center justify-center shrink-0">
                    ...
                    <div className="absolute text-[11px] font-extrabold text-slate-800 font-mono">
                      {Math.round((completedCount / 10) * 100)}%
                    </div>
                  </div>
                  <div>
                    <h4 className="text-[10px] font-extrabold text-[#1a2332] uppercase tracking-wider font-mono">Syllabus Completion</h4>
                    <p className="text-lg font-bold text-slate-900 leading-tight">
                      {completedCount} / 10 Units
                    </p>
                    <p className="text-[10px] text-slate-400 font-mono font-bold mt-0.5 uppercase">Study Portfolio Goal</p>
                  </div>
                </div>

                {/* Days Studied Streak Counter */}
                <div className="flex items-center gap-4 bg-white p-4 rounded-2xl border border-slate-200/80 shadow-3xs">
                  <div className="w-12 h-14 flex items-center justify-center shrink-0 relative bg-slate-50/50 rounded-xl border border-slate-100">
                    <Flame className={`w-8 h-8 ${isTodayStudied ? 'text-amber-500 fill-amber-300 animate-pulse' : 'text-slate-300 fill-slate-100'}`} />
                    {isTodayStudied && (
                      <span className="absolute -top-1 -right-1 w-2.5 h-2.5 rounded-full bg-emerald-500 ring-2 ring-white" />
                    )}
                  </div>
                  <div>
                    <h4 className="text-[10px] font-extrabold text-[#1a2332] uppercase tracking-wider font-mono">Daily Study Streak</h4>
                    <p className="text-lg font-bold text-slate-900 leading-tight">
                      {streakCount} {streakCount === 1 ? 'Day' : 'Days'}
                    </p>
                    <p className={`text-[10px] font-bold font-mono mt-0.5 uppercase ${isTodayStudied ? 'text-emerald-600' : 'text-slate-400'}`}>
                ...
                {/* Heatmap Grid Card */}
                <div className="md:col-span-2 bg-white p-4 rounded-2xl border border-slate-200/80 shadow-3xs flex flex-col justify-between">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-1.5">
                      <Activity className="w-3.5 h-3.5 text-emerald-500" />
                      <h4 className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider font-mono">Syllabus Grid Heatmap</h4>
                    </div>
                    <div className="flex gap-2.5 text-[8px] font-mono text-slate-400 font-bold uppercase select-none">
                      <span className="flex items-center gap-1">
                        <span className="w-2 h-2 rounded bg-slate-100 border border-slate-200 inline-block" /> Incomplete
                      </span>
                      <span className="flex items-center gap-1">
                      ...
                      return (
                        <button
                          ...
                          className={`h-9 flex flex-col items-center justify-center rounded-lg font-mono transition-all relative group cursor-pointer ${
                            ...
                            isSelected 
                              ? 'ring-2 ring-slate-800 font-black scale-102 shadow-2xs' 
                              : 'font-semibold'
                          }`}
                        >
                          ...
                          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block z-30 w-52 bg-slate-900/95 text-white text-[10px] p-2.5 rounded-xl shadow-md font-sans pointer-events-none leading-snug">
                            <p className="font-extrabold text-[8px] text-[#A8DADC] mb-0.5 font-mono uppercase tracking-wider">Unit {unit.id} • {unit.difficulty}</p>
                            <p className="font-bold line-clamp-1 mb-1">{unit.reading.title}</p>
                            <p className="text-[9px] text-slate-400 italic">Theme: {unit.theme}</p>
                            <div className="mt-1.5 pt-1.5 border-t border-slate-800/80 flex items-center justify-between text-[8px] font-mono uppercase font-bold text-slate-300">
                              <span>Status:</span>
            ...
            <button
              ...
              className={`px-3.5 py-2 text-[11px] rounded-xl border font-bold tracking-wide transition-all flex items-center justify-center gap-1.5 cursor-pointer select-none active:scale-97 w-full sm:w-auto font-mono uppercase ${
                isUnitCompleted(activeUnit.id)
                  ...
                  : 'bg-white hover:bg-slate-50 text-slate-500 hover:text-slate-800 border-slate-200/80 shadow-2xs'
              }`}
              title="Click to toggle completion status of this unit"
            >
              <CheckCircle className={`w-4 h-4 ${isUnitCompleted(activeUnit.id) ? 'text-emerald-600 fill-emerald-100' : 'text-slate-400'}`} />
              {isUnitCompleted(activeUnit.id) ? 'Unit Completed!' : 'Mark Completed'}
            </button>

            <div className="flex items-center gap-2 bg-slate-50 p-2.5 rounded-xl border border-slate-200/60 self-stretch md:self-auto justify-center w-full sm:w-auto">
              <GraduationCap className="w-5 h-5 text-slate-400 shrink-0" />
              <div className="text-left font-mono text-[10px] leading-tight">
                <p className="text-slate-400 uppercase tracking-widest font-extrabold pb-0.5">Grammar Focus</p>
          ...
          {isUnitCompleted(activeUnit.id) && studentReflections[activeUnit.id] && (
            ...
            >
              <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-4 flex gap-3 text-emerald-800">
                ...
                <div>
                  <h4 className="font-semibold text-xs uppercase tracking-wider font-mono text-emerald-700 mb-1">Your Unit Reflection</h4>
                          ...
                          <AnimatePresence>
                            {writingSubmitted[activeUnit.id] && (
                              ...
                              >
                                ...
                                <p className="text-slate-700 italic">"Your writing draft has been validated and added to your portfolio. Today's active learning progress is successfully logged to your study streak!"</p>
                              </motion.div>
                            )}
                          </AnimatePresence>
            ...
            >
              ...
              <div className="p-5 space-y-4">
                ...
                <textarea
                  ...
                  className="w-full h-32 p-3 text-sm bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 resize-none outline-none transition-all placeholder:text-slate-300"
                />
              </div>
              <div className="p-5 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">
                <button
                  onClick={() => setReflectionModalOpen({ isOpen: false, unitId: null })}
                  className="px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-slate-200/50 rounded-xl transition-colors cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-4 py-2 text-sm font-bold bg-indigo-600 text-white hover:bg-indigo-700 rounded-xl transition-colors shadow-sm cursor-pointer"
                >
                  Save & Complete
                </button>
              </div>
